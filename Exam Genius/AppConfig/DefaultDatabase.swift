...
struct DefaultDatabase {
    ...
    func getAllExamDetails() -> [ExamDetails] {
        [
            ...
            ExamDetails(name: "Law School Admission Test", acronym: "LSAT", category: .legal, about: "A standardized test for admissions to law schools in the USA.", image: "LSAT-Exam-Basic"),
            ...
            ExamDetails(name: "Test of English as a Foreign Language", acronym: "TOEFL", category: .language, about: "A standardized test to measure the English language ability of non-native speakers.", image: "TOFEL-Exam"),
            ...
            ExamDetails(name: "ACT Exam", acronym: "ACT", category: .education, about: "A standardized test for high school achievement and college admissions in the United States.", image: "ACT-Exam-Basic"),
            
            ExamDetails(name: "Advanced Placement Exams", acronym: "AP", category: .education, about: "Exams that offer high school students the opportunity to earn college credit, advanced placement, or both, in various subject areas.", image: "AFP-Exam-Basic"),
            ...
            ExamDetails(name: "US Citizenship Test", acronym: "USC", category: .legal, about: "", image: "USCitizenship"),
            ...
            ExamDetails(name: "Microsoft Azure Fundamentals Exam", acronym: "Azure Fundamentals", category: .technology, about: "Certification covering basic Azure concepts and services.", image: "Azure-Exam-Basic"),
            
            ExamDetails(name: "Cybersecurity Analyst Exam", acronym: "CySA+", category: .technology, about: "Certification for IT cybersecurity analysts focusing on threat detection and response.", image: "CYSA-Exam-Basic"),
            
            ExamDetails(name: "CompTIA Network+", acronym: "Network+", category: .technology, about: "Certification for networking professionals.", image: "COMPTIA-Exam-Basic"),
            
            ExamDetails(name: "CompTIA Security+", acronym: "Security+", category: .technology, about: "Certification dealing with core cybersecurity skills.", image: "COMPTIA-Security-Exam-Basic"),
            ...
            ExamDetails(name: "Certified Public Accountant", acronym: "CPA", category: .finance, about: "Licensure for accountants to practice public accounting in the United States.", image: "CPA-Exam-Basic"),
            
            ExamDetails(name: "Certified Internal Auditor", acronym: "CIA", category: .finance, about: "Certification for professionals who conduct internal audits.", image: "CIA-Exam-Basic"),
